    ...
    public ManagerFWG(World par1World, boolean remote, int biomes)
    {
        ...
        if(remote)
        {
            ...
            if(biomes == 0)
            {
                ...
                biomeList_snow.add(TFBiomeBase.tfSnow);
                biomeList_snow.add(TFBiomeBase.glacier);

                biomeList_cold.add(TFBiomeBase.twilightForest);
                biomeList_cold.add(TFBiomeBase.twilightForest2);
                biomeList_cold.add(TFBiomeBase.mushrooms);
                biomeList_cold.add(TFBiomeBase.clearing);
                biomeList_cold.add(TFBiomeBase.oakSavanna);
                biomeList_cold.add(TFBiomeBase.fireflyForest);
                biomeList_cold.add(TFBiomeBase.deepMushrooms);
                biomeList_cold.add(TFBiomeBase.darkForest);
                biomeList_cold.add(TFBiomeBase.enchantedForest);
                biomeList_cold.add(TFBiomeBase.darkForestCenter);
                biomeList_cold.add(TFBiomeBase.highlandsCenter);
                biomeList_cold.add(TFBiomeBase.thornlands);

                biomeList_hot.add(TFBiomeBase.fireSwamp);

                biomeList_wet.add(TFBiomeBase.tfLake);
                biomeList_wet.add(TFBiomeBase.tfSwamp);
